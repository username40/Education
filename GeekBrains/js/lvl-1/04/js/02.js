...
const game = {
  ...
  /**
   * проверяет, може ли пользователь перейти на точку
   * @param {{x: int, y:int}} nextPoint точка, которую преверяем.
   * @returns {boolean} true, если пользователь может перейти в направлении движения
   * иначе false
   */
