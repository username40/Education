...
const map = {
  ...
  render(snakePointsArray, foodPoint) {
    ...
    // Получаем элемент ячейки с едой по точfooddPoint.
...
/**
 * Объект счетчика, считает сколько осталось до победы
...
const score = {
  ...
  /**
   * Инкремент, прибавляет очки за каждую съеденную еду
   */
  increment() {
    this.count++;
    this.render();
