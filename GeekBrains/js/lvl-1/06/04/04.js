...
this имеется ввиду, что лежит в this.
...
в нашем случае клик был по картинке с крестиком, вот в this и будет лежать элемент этой картинки.
А как же объект gallery? Где он? А этот контекст теряется в таком случае.
...
В этом случае вызовется анонимная стрелочная функция. Дело в том, что стрелочная
функция не имеет контекста, она берет тот контекст, который существует в области видимости выше, вне ее
(в нашем случае это как раз gallery), т.е. внутри этой анонимной функции this будет gallery, а не элемент
